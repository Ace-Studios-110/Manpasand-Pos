...
class ColorService {
    async createColor(data) {
        ...
        const color = await db_1.prisma.color.create({
            data: {
                ...data,
                code: newCode
            },
    ...
    async updateColor(id, data) {
        ...
        return db_1.prisma.color.update({
            where: { id },
            data,
        });
    }
