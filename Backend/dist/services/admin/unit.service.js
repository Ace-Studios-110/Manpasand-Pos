...
class UnitService {
    async createUnit(data) {
        ...
        const unit = await db_1.prisma.unit.create({
            data: {
                ...data,
                code: newCode
            },
    ...
    async getUnitById(id) {
        const unit = await db_1.prisma.unit.findUnique({
            where: { id },
            include: {
                products: {
    ...
    async updateUnit(id, data) {
        ...
        return db_1.prisma.unit.update({
            where: { id },
            data,
        });
    }
